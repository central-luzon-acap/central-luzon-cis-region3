...
class SeasonalTabGeneral extends ExcelTabDefinition {
  constructor (crop, stages) {
    super()
    this.crop = crop
    this.excelTabNumber = 3
    this.type = RECOMMEDATIONS_TYPE.SEASONAL_GENERAL
    this.description = 'Seasonal General Crop Recommendations'
...
module.exports = SeasonalTabGeneral
