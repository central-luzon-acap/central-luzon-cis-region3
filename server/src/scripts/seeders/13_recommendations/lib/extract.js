...
module.exports.extractExcelData = (ExcelTab, excelFilePath) => {
  ...
  // Normalize the special recommendations' farm operations - expand rows vertically
  // For example, multiple farm operations are joined in one long string "Water Management / Pest and Weed Management / Fertilizer Application" for manual encoding simplicity
  // Each farm operation should contain similar recommendations text
