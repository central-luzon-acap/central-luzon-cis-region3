...
function CroppingCalendarSeasonalComponent(props) {
  const {
    optsprovinces,
    subcalendar,
    processedCalendar,
  ...
  return (
    <Card variant="outlined" sx={styles.card}>
      ...
      {loading && sel_options.error === '' ? (
        ...
        <Box sx={styles.infoMsg}>No available data.</Box>
      )}
    </Card>
  )
}

CroppingCalendarSeasonalComponent.propTypes = {
...
export default CroppingCalendarSeasonalComponent
